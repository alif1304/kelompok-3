                ...
                <div class="card">
                    <div class="card-body">
                        <p class="card-description">
                            <a href="{{ route('ap.items.create') }}"><button type="button"
                                    ...
                                    <form action="" method="GET" role="search">
                                        <div class="input-group">
                                            ...
                                            <input name="keyword" id="keyword" class="form-control mr-1 mt-2"
                                                placeholder="Cari berdasarkan nama Seafood"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                @php $total = 0 @endphp
                                                @if($i->discount > 0)
                                                @php $total += $i['price'] - (($i['price'] * $i['discount']) / 100)
                                                @endphp
                                                @else($i->discount = 0)
                                            ...
                                            <td>
                                                <div class="d-flex centered">
                                                    <a href="{{ route('ap.items.show', $i->id) }}"
                                                    ...
                                                    <a href="{{ route('ap.items.edit', $i->id) }}"
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger"
                                                        ...
                                                        data-target="#delete_categories_{{ $i->id }}">
                                                        <i class="fas fa-trash"></i> Hapus
                                                    </button>

                                                    <div class="modal fade" id="delete_categories_{{ $i->id }}"
                                                        tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form action="{{ route('ap.items.destroy', $i->id)}}"
                                                                id="form_delete_post_{{ $i->id }}" method="post">
                                                                @csrf
                                                                @method('DELETE');
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Yakin mau hapus kategori "<b>{{ $i->nm_category
                                                                            }}</b>" ?
                                                                    </div>
