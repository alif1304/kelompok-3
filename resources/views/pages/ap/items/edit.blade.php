...
@section('title')
Admin | Ubah Seafood {{ config('settings.name') }}
@endsection
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2><i class="nav-icon fab fa-product-hunt"></i> Seafood</h2>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('ap.items.index') }}">Seafood</a></li>
                            <li class="breadcrumb-item active">Ubah Seafood</li>
                        </ol>
                    </div>
                </div>
        </section>
        <form class="forms-sample" action="{{ route('ap.items.update',$item->id) }}" method="POST"
            enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Ubah Seafood</h4>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                <label for="description">Deskripsi Seafood</label>
                                <textarea
                                    class="ckeditor form-control @if($errors->has('description')) is-invalid @endif"
                                    id="description" name="description" rows="15"
                            ...
                            <div class="form-group">
                                <label for="quantity">Jumlah Seafood</label>
                                <input type="number"
                            ...
                            <div class="form-group">
                                <label for="price">Harga Seafood</label>
                            ...
                            <div class="form-group">
                                <label for="discount">Diskon Seafood</label>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Gambar Seafood</h4>
                            <div class="col-auto">
                                ...
                                <span class="form-text text-danger text-sm">* Kosongkan jika tidak ingin mengubah
                                    gambar.</span>
                            </div>
                            <div class="col-auto">
                                ...
                                <table class="table table-borderless align-items-center">
                                    <tr>
                                        <td>
                                            <img src="{{ asset('/images/items/'.$data->value) }}"
                                                style="height:150px; width:270px" class="rounded float-left" />
                                        </td>
                                        <td>
                                            <button class="btn btn-outline-danger py-3 delete-{{ $data->id }}"
                                                type="button" onclick="deleteImage({{ $data->id }})"><i
