            ...
            <div class="row">
                <div class="col-xxl-8 px-4 py-5" data-aos="zoom-in">
                    ...
                    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                        ...
                        <div class="col-lg-6">
                            <h1 style= "font-size: 20px" ; "font-family: fantasy;" ; class="display-5 font-weight-bold mb-3">{{ config('settings.name') }} Selamat Datang Di Toko B-J-N penjualan Seafood , 
                                hasil nelayan Lokal terpercaya disini
                            </h1>
