    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2><i class="nav-icon fas fa-book"></i> Kategori Seafood</h2>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('ap.categories.index') }}">Kategori Seafood</a>
                            </li>
                            <li class="breadcrumb-item active">Ubah Kategori Seafood</li>
                        </ol>
                    </div>
                </div>
        </section>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('ap.categories.update',$category->id) }}"
                            ...
                            <div class="form-group">
                                <label for="nm_category">Jenis Seafood</label>
